...
namespace AwesomeTechnologies
{
    ...
    public class VegetationMask : MonoBehaviour
    {
        ...
        public void AddNode(Vector3 worldPosition)
        {
            ...
            MathLib.Segment3 nextSegment = new MathLib.Segment3(transform.TransformPoint(closestNode.Position), transform.TransformPoint(nextNode.Position));
            MathLib.Segment3 previousSegment = new MathLib.Segment3(transform.TransformPoint(closestNode.Position), transform.TransformPoint(previousNode.Position));
