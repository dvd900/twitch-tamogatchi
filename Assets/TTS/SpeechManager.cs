...
public class SpeechManager : MonoBehaviour {
    ...
    void Start () {
        ...
        Task<string> authenticating = auth.Authenticate("https://eastus.api.cognitive.microsoft.com/sts/v1.0/issueToken",
                                                 "0020d621677644699883b571aff78f42"); // INSERT-YOUR-BING-SPEECH-API-KEY-HERE
    ...
    public void Speak(string message)
    {
        try
        {
            ...
            string requestUri = "https://eastus.voice.speech.microsoft.com/cognitiveservices/v1?deploymentId=8563df33-dbad-4763-a99e-24f747efe749";
