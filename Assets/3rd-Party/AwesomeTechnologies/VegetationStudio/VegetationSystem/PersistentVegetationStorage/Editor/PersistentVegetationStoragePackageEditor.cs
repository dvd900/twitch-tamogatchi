...
namespace AwesomeTechnologies.Vegetation.PersistentStorage
{
    ...
    public class PersistentVegetationStoragePackageEditor : VegetationStudioBaseEditor
    {
        ...
        {
            ScriptableObjectUtility2.CreateAndReturnAsset<PersistentVegetationStoragePackage>();
        }
